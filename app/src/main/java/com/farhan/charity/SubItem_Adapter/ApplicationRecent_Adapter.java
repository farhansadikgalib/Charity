...
public class ApplicationRecent_Adapter extends  RecyclerView.Adapter<ApplicationRecent_Adapter.ViewHolder> {

    private Context context;
    private List<ItemModel> itemModelList;

    public ApplicationRecent_Adapter(Context context, List<ItemModel> list) {
        this.context = context;
        this.itemModelList = list;
    }

    @Override
    public ApplicationRecent_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.row_layout_2, parent, false);
        return new ApplicationRecent_Adapter.ViewHolder(v);
    }
